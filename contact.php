            ...
            <div class="col-lg-5 col-xl-5 contact-form wow fadeInLeft" data-wow-delay="0.1s">
                ...
                <form method="post">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-12 col-xl-6">
                            <div class="form-floating">
                                <input type="text" class="form-control bg-transparent border border-white" id="project" placeholder="Project" name="project">
                                <label for="project">Your Project</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="text" class="form-control bg-transparent border border-white" id="subject" placeholder="Subject" name="subject">
                                <label for="subject">Subject</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control bg-transparent border border-white" placeholder="Leave a message here" id="message" style="height: 160px" name="massage"></textarea>
                                <label for="message">Message</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <button class="btn btn-light text-primary w-100 py-3" name="btn">Send Message</button>
                        </div>
                    </div>
                </form>
            </div>
...
if(isset($_POST['btn'])) {
    ...
    $query = "INSERT INTO `contact`(`Name`, `Email`, `Phone`, `project`, `subject`, `massage`) VALUES ('$name','$email','$phone','$project','$subject','$massage')";
