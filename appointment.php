                        ...
                        <div class="appointment-form rounded p-5">
                            ...
                            <form method="post">
                                <div class="row gy-3 gx-4">
                                    ...
                                    <div class="col-xl-6">
                                        <input type="date" class="form-control py-3 border-primary bg-transparent" name="date">
                                    </div>
                                    <div class="col-xl-6">
                                    ...
                                    <div class="col-12">
                                        <textarea class="form-control border-primary bg-transparent text-white" name="massage" id="area-text" cols="30" rows="5" placeholder="Write Comments"></textarea>
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" class="form-control" id="cf-submit" name="bton">Submit Button</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
if(isset($_POST['bton'])){
    ...
    $query = "INSERT INTO `appoinment`(`Name`, `Email`, `Phone`, `Gender`, `date`, `department`, `massage`) VALUES ('$name','$email','$phone','$gender','$date','$department','$massage')";
